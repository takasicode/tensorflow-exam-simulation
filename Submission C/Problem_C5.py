...
Original file is located at
    https://colab.research.google.com/drive/1-jtUfHPMWPi2w34_JchMVKxLpdAib1Wj
"""
...
def solution_C5():
    ...
    train_data = data[:split_time] # YOUR CODE HERE
    test_data = data[split_time:] # YOUR CODE HERE
    ...
    train_set = windowed_dataset(train_data, BATCH_SIZE, N_PAST, N_FUTURE, SHIFT) # YOUR CODE HERE
    test_set = windowed_dataset(test_data, BATCH_SIZE, N_PAST, N_FUTURE, SHIFT) # YOUR CODE HERE
    ...
    model.fit(train_set, epochs=30, validation_data=test_set, batch_size=BATCH_SIZE, callbacks=[MyCallback()])
